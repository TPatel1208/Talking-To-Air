...
export default function RightPanel({ discovery, jobs, jobsError, onCancelJob, onRefreshJobs, onRetrieve, onViewResult, onCollapse }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '18px', flexShrink: 0 }}>
        <div style={{ display: 'flex', gap: '4px', background: 'var(--bg-secondary)', borderRadius: '9px', padding: '3px', flex: 1 }}>
          <div
        ...
        {onCollapse && (
          <button
            type="button"
            onClick={onCollapse}
            title="Collapse jobs and discover"
            aria-label="Collapse jobs and discover"
            style={{
