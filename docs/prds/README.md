...
| [T28](prd-t28-compare-mode-selection-and-map-panels.md) | Compare mode: selection, layout, and map panels | T23 |
| [T29](prd-t29-compare-mode-chart-overlay-panels.md) | Compare mode: chart overlay panels | T28 |
