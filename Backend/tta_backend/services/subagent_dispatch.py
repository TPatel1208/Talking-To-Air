...
from tta_backend.models import AgentResult, SubAgentEnvelope, parse_agent_result, parse_chart_payload, parse_sub_agent_envelope
...
from tta_backend.utils.message_utils import extract_last_text, truncate_text
from tta_backend.utils.metrics import record_agent_request, record_envelope_salvaged
from tta_backend.utils.streaming import get_call_budget, stream_response
...
def _attach_variable_choice(
    ...
    if not payload:
        return result
    from tta_backend.models import VariableChoice
    from tta_backend.preprocessing.variable_choice_builder import fill_prompts
