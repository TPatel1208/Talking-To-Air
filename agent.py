...
1. **Identify the variable** the user wants. If they say "NO2" without specifying a sensor,
   default to OMI_NO2 unless they mention hourly data (use TEMPO_NO2) or monthly trends (use TROPOMI_NO2).
...
- **Error handling**: If any step fails, report the error clearly and stop.
